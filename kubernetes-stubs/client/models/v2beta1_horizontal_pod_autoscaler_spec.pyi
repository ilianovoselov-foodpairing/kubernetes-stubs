...
class V2beta1HorizontalPodAutoscalerSpec:
    max_replicas: int
    metrics: typing.Optional[typing.List[kubernetes.client.V2beta1MetricSpec]]
    ...
    def __init__(
        ...
        *,
        ...
        metrics: typing.Optional[
            typing.List[kubernetes.client.V2beta1MetricSpec]
        ] = ...,
        min_replicas: typing.Optional[int] = ...,
        scale_target_ref: kubernetes.client.V2beta1CrossVersionObjectReference
    ) -> None: ...
...
class V2beta1HorizontalPodAutoscalerSpecDict(typing.TypedDict, total=False):
    maxReplicas: int
    metrics: typing.Optional[typing.List[kubernetes.client.V2beta1MetricSpecDict]]
