...
class V1alpha1PriorityLevelConfigurationStatus:
    conditions: typing.Optional[
        typing.List[kubernetes.client.V1alpha1PriorityLevelConfigurationCondition]
    ]
    def __init__(
        self,
        *,
...
class V1alpha1PriorityLevelConfigurationStatusDict(typing.TypedDict, total=False):
    conditions: typing.Optional[
        typing.List[kubernetes.client.V1alpha1PriorityLevelConfigurationConditionDict]
    ]
