...
class V1DeploymentStatus:
    ...
    conditions: typing.Optional[typing.List[kubernetes.client.V1DeploymentCondition]]
    ...
    def __init__(
        ...
        *,
        ...
        conditions: typing.Optional[
            typing.List[kubernetes.client.V1DeploymentCondition]
        ] = ...,
        observed_generation: typing.Optional[int] = ...,
        ready_replicas: typing.Optional[int] = ...,
        replicas: typing.Optional[int] = ...,
...
class V1DeploymentStatusDict(typing.TypedDict, total=False):
    ...
    conditions: typing.Optional[
        typing.List[kubernetes.client.V1DeploymentConditionDict]
    ]
