...
class V2beta1HorizontalPodAutoscalerStatus:
    conditions: typing.List[kubernetes.client.V2beta1HorizontalPodAutoscalerCondition]
    current_metrics: typing.Optional[typing.List[kubernetes.client.V2beta1MetricStatus]]
    ...
    def __init__(
        ...
        *,
        conditions: typing.List[
            kubernetes.client.V2beta1HorizontalPodAutoscalerCondition
        ],
        current_metrics: typing.Optional[
            typing.List[kubernetes.client.V2beta1MetricStatus]
        ] = ...,
        current_replicas: int,
        desired_replicas: int,
        last_scale_time: typing.Optional[datetime.datetime] = ...,
...
class V2beta1HorizontalPodAutoscalerStatusDict(typing.TypedDict, total=False):
    conditions: typing.List[
        kubernetes.client.V2beta1HorizontalPodAutoscalerConditionDict
    ]
    currentMetrics: typing.Optional[
        typing.List[kubernetes.client.V2beta1MetricStatusDict]
    ]
    currentReplicas: int
    desiredReplicas: int
