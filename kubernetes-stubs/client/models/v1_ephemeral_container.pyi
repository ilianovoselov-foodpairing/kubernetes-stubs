...
class V1EphemeralContainer:
    ...
    name: str
    ports: typing.Optional[typing.List[kubernetes.client.V1ContainerPort]]
    ...
    volume_devices: typing.Optional[typing.List[kubernetes.client.V1VolumeDevice]]
    ...
    def __init__(
        ...
        *,
        ...
        volume_devices: typing.Optional[
            typing.List[kubernetes.client.V1VolumeDevice]
        ] = ...,
...
class V1EphemeralContainerDict(typing.TypedDict, total=False):
    ...
    name: str
    ports: typing.Optional[typing.List[kubernetes.client.V1ContainerPortDict]]
    ...
    tty: typing.Optional[bool]
    volumeDevices: typing.Optional[typing.List[kubernetes.client.V1VolumeDeviceDict]]
