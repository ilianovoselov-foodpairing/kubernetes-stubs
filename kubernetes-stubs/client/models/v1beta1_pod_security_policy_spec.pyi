...
class V1beta1PodSecurityPolicySpec:
    ...
    allowed_csi_drivers: typing.Optional[typing.List[V1beta1AllowedCSIDriver]]
    allowed_capabilities: typing.Optional[typing.List[str]]
    allowed_flex_volumes: typing.Optional[typing.List[V1beta1AllowedFlexVolume]]
    allowed_host_paths: typing.Optional[typing.List[V1beta1AllowedHostPath]]
    ...
    host_ports: typing.Optional[typing.List[V1beta1HostPortRange]]
    ...
    run_as_group: typing.Optional[V1beta1RunAsGroupStrategyOptions]
    run_as_user: V1beta1RunAsUserStrategyOptions
    runtime_class: typing.Optional[V1beta1RuntimeClassStrategyOptions]
    ...
    def __init__(
        ...
        *,
        ...
        allowed_csi_drivers: typing.Optional[
            typing.List[V1beta1AllowedCSIDriver]
        ] = ...,
        allowed_capabilities: typing.Optional[typing.List[str]] = ...,
        allowed_flex_volumes: typing.Optional[
            typing.List[V1beta1AllowedFlexVolume]
        ] = ...,
        allowed_host_paths: typing.Optional[typing.List[V1beta1AllowedHostPath]] = ...,
        allowed_proc_mount_types: typing.Optional[typing.List[str]] = ...,
        allowed_unsafe_sysctls: typing.Optional[typing.List[str]] = ...,
...
class V1beta1PodSecurityPolicySpecDict(typing.TypedDict, total=False):
    ...
    allowedCSIDrivers: typing.Optional[typing.List[V1beta1AllowedCSIDriverDict]]
    allowedCapabilities: typing.Optional[typing.List[str]]
    allowedFlexVolumes: typing.Optional[typing.List[V1beta1AllowedFlexVolumeDict]]
    allowedHostPaths: typing.Optional[typing.List[V1beta1AllowedHostPathDict]]
    ...
    hostPorts: typing.Optional[typing.List[V1beta1HostPortRangeDict]]
    privileged: typing.Optional[bool]
    readOnlyRootFilesystem: typing.Optional[bool]
    requiredDropCapabilities: typing.Optional[typing.List[str]]
    runAsGroup: typing.Optional[V1beta1RunAsGroupStrategyOptionsDict]
    runAsUser: V1beta1RunAsUserStrategyOptionsDict
    runtimeClass: typing.Optional[V1beta1RuntimeClassStrategyOptionsDict]
