...
class ExtensionsV1beta1IngressSpec:
    ...
    rules: typing.Optional[typing.List[kubernetes.client.ExtensionsV1beta1IngressRule]]
    tls: typing.Optional[typing.List[kubernetes.client.ExtensionsV1beta1IngressTLS]]
    def __init__(
        self,
        *,
        ...
        rules: typing.Optional[
            typing.List[kubernetes.client.ExtensionsV1beta1IngressRule]
        ] = ...,
        tls: typing.Optional[
            typing.List[kubernetes.client.ExtensionsV1beta1IngressTLS]
        ] = ...
    ) -> None: ...
...
class ExtensionsV1beta1IngressSpecDict(typing.TypedDict, total=False):
    ...
    rules: typing.Optional[
        typing.List[kubernetes.client.ExtensionsV1beta1IngressRuleDict]
    ]
    tls: typing.Optional[typing.List[kubernetes.client.ExtensionsV1beta1IngressTLSDict]]
