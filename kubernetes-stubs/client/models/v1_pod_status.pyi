...
class V1PodStatus:
    conditions: typing.Optional[typing.List[kubernetes.client.V1PodCondition]]
    container_statuses: typing.Optional[
        typing.List[kubernetes.client.V1ContainerStatus]
    ]
    ...
    pod_i_ps: typing.Optional[typing.List[kubernetes.client.V1PodIP]]
    ...
    def __init__(
        ...
        *,
        conditions: typing.Optional[
            typing.List[kubernetes.client.V1PodCondition]
        ] = ...,
        container_statuses: typing.Optional[
            typing.List[kubernetes.client.V1ContainerStatus]
        ] = ...,
...
class V1PodStatusDict(typing.TypedDict, total=False):
    conditions: typing.Optional[typing.List[kubernetes.client.V1PodConditionDict]]
    containerStatuses: typing.Optional[
        typing.List[kubernetes.client.V1ContainerStatusDict]
    ]
    ...
    podIPs: typing.Optional[typing.List[kubernetes.client.V1PodIPDict]]
