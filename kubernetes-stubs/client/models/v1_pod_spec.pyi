...
class V1PodSpec:
    ...
    containers: typing.List[kubernetes.client.V1Container]
    ...
    ephemeral_containers: typing.Optional[
        typing.List[kubernetes.client.V1EphemeralContainer]
    ]
    host_aliases: typing.Optional[typing.List[kubernetes.client.V1HostAlias]]
    ...
    init_containers: typing.Optional[typing.List[kubernetes.client.V1Container]]
    ...
    readiness_gates: typing.Optional[typing.List[kubernetes.client.V1PodReadinessGate]]
    ...
    topology_spread_constraints: typing.Optional[
        typing.List[kubernetes.client.V1TopologySpreadConstraint]
    ]
    ...
    def __init__(
        ...
        *,
        ...
        init_containers: typing.Optional[
            typing.List[kubernetes.client.V1Container]
        ] = ...,
        node_name: typing.Optional[str] = ...,
        node_selector: typing.Optional[typing.Dict[str, str]] = ...,
        overhead: typing.Optional[typing.Dict[str, str]] = ...,
        ...
        readiness_gates: typing.Optional[
            typing.List[kubernetes.client.V1PodReadinessGate]
        ] = ...,
        restart_policy: typing.Optional[str] = ...,
        runtime_class_name: typing.Optional[str] = ...,
        scheduler_name: typing.Optional[str] = ...,
...
class V1PodSpecDict(typing.TypedDict, total=False):
    ...
    containers: typing.List[kubernetes.client.V1ContainerDict]
    ...
    ephemeralContainers: typing.Optional[
        typing.List[kubernetes.client.V1EphemeralContainerDict]
    ]
    hostAliases: typing.Optional[typing.List[kubernetes.client.V1HostAliasDict]]
    ...
    initContainers: typing.Optional[typing.List[kubernetes.client.V1ContainerDict]]
    ...
    readinessGates: typing.Optional[
        typing.List[kubernetes.client.V1PodReadinessGateDict]
    ]
    ...
    topologySpreadConstraints: typing.Optional[
        typing.List[kubernetes.client.V1TopologySpreadConstraintDict]
    ]
